...
ESTILOS: dict[str, dict[str, Any]] = {
    ...
    "pixar_animado": {
        ...
        "modelo_fal": "fal-ai/hailuo-ai/i2v-01",
        "fps": 24,
    ...
    "avengers": {
        ...
        "prefijo_prompt": "Marvel Avengers style, epic superhero scene, dramatic backlight, cinematic VFX,",
        "sufijo_prompt": "MCU visual quality, lens flares, epic scale, IMAX cinematic, dynamic hero pose",
        "negative": "mundane setting, casual clothes, no powers visible, static camera, boring",
        "modelo_fal": "fal-ai/kling-video/v2.1/pro/image-to-video",
        "fps": 24,
