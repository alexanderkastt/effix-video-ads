...
HABLADO: dict[str, list[str]] = {
    "comunidad_que_no_tienes": [
        ...
        "Quince al diecinueve de octubre. Código EFFIX veinte.",
    ...
    "no_esta_en_cursos": [
        ...
        "Plaza Mayor, Medellín. Código EFFIX veinte.",
...
CTA_POR_PASE: dict[str, dict[str, str]] = {
    ...
    "generico": {
        "hablado": "Quince al diecinueve de octubre. Código EFFIX veinte.",
        "overlay": "15–19 oct · Código EFFIX20",
        "dias": "",
    },
}
